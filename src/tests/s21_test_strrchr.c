...
#define ACTUAL(x, y) s21_strrchr(x, y)
#define EXPECTED(x, y) strrchr(x, y)
#define SUITE_LABEL "suite_s21_strrchr"
#define SUITE_NAME *suite_s21_strrchr()
#define STRINGS strings_strrchr
...
START_TEST(test) {
  ...
  do {
    ...
    // *ptr_symbol, actual_result, expected_result);  //print for debug
