...
#define ACTUAL(x, y, z) s21_strncat(x, y, z)
#define EXPECTED(x, y, z) strncat(x, y, z)
#define SUITE_LABEL "suite_s21_strncat"
#define SUITE_NAME *suite_s21_strncat()
#define STRINGS strings_strncat
