...
#define ACTUAL(x, y) s21_strpbrk(x, y)
#define EXPECTED(x, y) strpbrk(x, y)
#define SUITE_LABEL "suite_s21_strpbrk"
#define SUITE_NAME *suite_s21_strpbrk()
#define STRINGS strings_strpbrk
...
START_TEST(test) { 
	...
	actual_result = ACTUAL(STRINGS[_i], str2);
	expected_result = EXPECTED(STRINGS[_i], str2);
